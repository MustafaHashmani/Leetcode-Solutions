...
## Easy
<div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">You a given a number <strong>N</strong>. You need to print the pattern for the given value of <strong>N</strong>.<br>
<br>
...
<p><strong><span style="font-size:18px">Note: </span></strong><span style="font-size:18px">Instead of printing a&nbsp;new line print a "$" without quotes.After printing the total output , end of line is expected.</span><br>
<br>
